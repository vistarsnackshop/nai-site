...
export default function BrowseBidItem() {
    ...
    const breadcrumbs = [
        ...
        { name: "Bid Items", href: "/browsebiditem?bidid=${bidId}" }
    ];
    ...
    const [selectedWhsDs, setSelectedWhsDs] = useState<string | null>(null);
    ...
    useEffect(() => {
        if (typeof window !== 'undefined') {
            ...
            const whsDs = localStorage.getItem("whsDescription");
            setSelectedWhsDs(whsDs);
        }
    }, []);
    ...
    return (
        <div>
            ...
            <div className="text-gray-700 text-2xl font-extrabold mb-5 flex justify-center">
                <p>Currently Viewing Bid: {selectedBidId}, {selectedWhsDs}</p>
            </div>
                                    ...
                                    <TableCell>
                                        {columnKey === 'viewInventory' ? (
                                            <div className="flex items-center justify-center">
                                                <InventoryButton itemId={item.ITMID.trim()} whsId={whsId as string} whsDS={selectedWhsDs as string} onClick={() => handleClick(item.ITEMDS)}>Inventory</InventoryButton>
                                            </div>
