...
function BrowseOpcoItemContent() {
  ...
  const [selectedWhsDescription, setSelectedWhsDescription] =
                  ...
                  <TableCell>
                    {columnKey === "viewInventory" ? (
                      <div className="flex items-center justify-center">
                        <InventoryButton
                          itemId={item.ITMID.trim()}
                          whsId={whsId as string}
                          whsDS={selectedWhsDescription as string}
                          onClick={() => handleClick(item.ITEMDS)}
                        >
                          Inventory
                        </InventoryButton>
                      </div>
                      ...
                      <div className="flex items-center justify-center">
                        <InvoiceButton itemId={item.ITMID.trim()} whsId={whsId as string}>
                          Invoices
                        </InvoiceButton>
                      </div>
                    ) : (
