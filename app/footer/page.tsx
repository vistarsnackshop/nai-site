            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
                <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                    <a href="https://vistar.com/"  className="flex justify-center lg:justify-start">
                        <img src='vistar-logo.png'></img>
                    </a>
                    <p className="py-4 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left font-extrabold">Get in touch!</p>
                    <p className="pb-4 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left">Want to learn more about Vistar? We are happy to answer questions!</p>
                    <a href='https://vistar.com/Subnav-Contact/Contact-Us'>
                    <button
                    type="button"
                    className="w-1/2 shadow-xl py-2.5 px-4 text-sm font-semibold rounded-full text-white bg-vistarGreen hover:bg-vistarGreenHover focus:outline-none"
                    >
                     Contact Us
                    </button>
                    </a>
